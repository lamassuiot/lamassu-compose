...
# export LAMASSU_GATEWAY_DOCKER_IMAGE="lamassuiot/lamassu-gateway:1.1.0"
# export LAMASSU_AUTH_DOCKER_IMAGE="lamassuiot/lamassu-auth:1.1.0"
# export LAMASSU_RABBITMQ_DOCKER_IMAGE="lamassuiot/lamassu-rabbitmq:1.1.0"
